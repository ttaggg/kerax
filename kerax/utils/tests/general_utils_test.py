...
class GeneralUtilsTest(absltest.TestCase):
    ...
    def test_get_config(self):
        ...
        gutils.get_config('kerax/testdata/minimal_config.py')

        config = gutils.get_config('kerax/testdata/maximal_config.py')
        ...
        with self.assertRaises(FileNotFoundError):
            gutils.get_config('kerax/testdata/nonexisting_config.py')
    ...
    def test_get_model(self):
        ...
        ckpt = 'kerax/testdata/chpt.01.hdf5'
        ...
        # Raise if no such directory.
        with self.assertRaises(FileNotFoundError):
            gutils.get_model('kerax/testdata/empty_dir')
